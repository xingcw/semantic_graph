...
class AttentionModule(torch.nn.Module):
    ...
    def forward(self, embedding):
        ...
        sigmoid_scores = torch.sigmoid(torch.matmul(embedding, transformed_global.view(batch_size, -1, 1)))
        # weights      nxf fx1  bxnxf bxfx1 bxnx1
...
class TenorNetworkModule(torch.nn.Module):
    ...
    def forward(self, embedding_1, embedding_2):
        ...
        scoring = torch.matmul(embedding_1.permute(0, 2, 1), self.weight_matrix.view(self.args.filters_3, -1)).view(
            batch_size, self.args.filters_3, self.args.tensor_neurons)
